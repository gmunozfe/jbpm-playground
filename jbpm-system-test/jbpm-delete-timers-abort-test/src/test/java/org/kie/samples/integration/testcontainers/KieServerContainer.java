...
public class KieServerContainer extends GenericContainer<KieServerContainer>{
    ...
    public KieServerContainer(Network network, Map<String,String> args) {
      super( new ImageFromDockerfile()
           ...
           .withFileFromClasspath("etc/jbpm-flow-7.67.0.Final-redhat-00008-RHPAM-4484.jar", "etc/jbpm-flow-7.67.0.Final-redhat-00008-RHPAM-4484.jar")
           .withFileFromClasspath("etc/jbpm-runtime-manager-7.67.0.Final-redhat-00008-RHPAM-4484.jar", "etc/jbpm-runtime-manager-7.67.0.Final-redhat-00008-RHPAM-4484.jar")
           .withFileFromClasspath("etc/jbpm-services-ejb-timer-7.67.0.Final-redhat-00008-RHPAM-4484.jar", "etc/jbpm-services-ejb-timer-7.67.0.Final-redhat-00008-RHPAM-4484.jar")
